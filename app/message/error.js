  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-primary mb-2">Failed to load messages</h2>
        <p className="text-primary/60 mb-6">{error?.message || 'Could not load messages. Please try again.'}</p>
